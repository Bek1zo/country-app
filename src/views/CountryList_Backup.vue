...
const onDrop = (event, targetItem) => {
  ...
  const draggedIndex = countries.indexOf(draggedItem);
  const targetIndex = countries.indexOf(targetItem);

  countries.splice(draggedIndex, 1);
  countries.splice(targetIndex, 0, draggedItem);
};
